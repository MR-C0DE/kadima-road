// app/(tabs)/diagnostic.tsx - Version avec écran de chargement après les questions
...
export default function DiagnosticScreen() {
  ...
  const [showProcessing, setShowProcessing] = useState(false); // ⚡ NOUVEAU : écran de chargement après questions
  ...
  const [questionProgressAnim] = useState(new Animated.Value(0));
  const [processingProgressAnim] = useState(new Animated.Value(0));
  ...
  useEffect(() => {
    ...
    // Animation de rotation pour l'écran de chargement
    Animated.loop(
  ...
  const handleAnswer = (answer: string) => {
    ...
    if (currentQuestionIndex + 1 < currentQuestions.length) {
      ...
      // ⚡ DERNIÈRE QUESTION : afficher l'écran de chargement
  ...
  const renderProcessingScreen = () => {
    ...
    const progressWidth = processingProgressAnim.interpolate({
      inputRange: [0, 1],
      outputRange: ["0%", "100%"],
    });
      ...
      <View style={[styles.container, { backgroundColor: colors.background }]}>
        ...
        <View style={styles.loadingContent}>
          ...
          <View style={styles.loadingProgressContainer}>
            ...
            >
              {Math.floor(processingProgressAnim._value * 100)}%
            </Text>
          </View>

          <View style={styles.loadingSteps}>
            <Animated.View style={[styles.loadingStep, { opacity: fadeAnim }]}>
              <View
                style={[
              ...
              {processingProgressAnim._value > 0.3 && (
            ...
            <Animated.View
              style={[
                styles.loadingStep,
                { opacity: fadeAnim, marginLeft: 10 },
              ]}
            >
              <View
                style={[
              ...
              {processingProgressAnim._value > 0.6 && (
                <Ionicons name="checkmark-circle" size={16} color="#4CAF50" />
              )}
            </Animated.View>
            ...
            <Animated.View
              style={[
                styles.loadingStep,
                { opacity: fadeAnim, marginLeft: 20 },
              ]}
            >
              <View
                style={[
              ...
              {processingProgressAnim._value > 0.9 && (
                <Ionicons name="checkmark-circle" size={16} color="#4CAF50" />
              )}
            </Animated.View>
          </View>
  ...
  // Rendu des questions avec boutons Oui/Non
  ...
  // ⚡ Afficher l'écran de chargement après les questions
  if (showProcessing) {
      ...
      >
        ...
        >
          ...
          <View style={styles.descriptionSection}>
            ...
            >
              <TextInput
                style={[styles.input, { color: colors.text, height: 150 }]}
...
const styles = StyleSheet.create({
  ...
  circle2: { bottom: -width * 0.2, left: -width * 0.2 },
  ...
  quickDiagnosticSection: { marginTop: 20, marginBottom: 20 },
  sectionHeader: {
    flexDirection: "row",
    justifyContent: "space-between",
    alignItems: "center",
  ...
  scrollHintText: { fontSize: 12 },
  quickDiagnosticScroll: { paddingHorizontal: 20, gap: 12, paddingRight: 30 },
  quickDiagnosticItem: { width: 100, marginRight: 5 },
  quickDiagnosticItemSelected: { transform: [{ scale: 1.05 }] },
  ...
  quickDiagnosticDesc: { fontSize: 10, textAlign: "center" },
  scrollEndIndicator: {
    width: 40,
    height: 100,
    justifyContent: "center",
  ...
  quickButtonWrapper: { width: "48%", marginBottom: 12 },
  quickButton: { borderRadius: 16, overflow: "hidden" },
  quickButtonSelected: {
    shadowColor: "#000",
    shadowOffset: { width: 0, height: 4 },
    shadowOpacity: 0.3,
  ...
  quickButtonGradient: { padding: 16, alignItems: "center", borderRadius: 16 },
  quickLabel: {
    fontSize: 14,
    fontWeight: "600",
    marginTop: 8,
  ...
  quickDesc: { fontSize: 10, textAlign: "center" },
  ...
  input: { padding: 16, fontSize: 16, textAlignVertical: "top" },
  suggestionsContainer: { marginBottom: 20 },
  suggestionsTitle: { fontSize: 14, marginBottom: 10 },
  suggestionChips: { flexDirection: "row", flexWrap: "wrap", gap: 10 },
  suggestionChip: {
  ...
  questionsOverlay: { flex: 1, justifyContent: "center", alignItems: "center" },
  questionsContainer: {
    width: "85%",
    borderRadius: 28,
    overflow: "hidden",
  ...
  questionsHeader: { padding: 20, alignItems: "center" },
  questionsTitle: { fontSize: 20, fontWeight: "bold", color: "#fff" },
  questionsSubtitle: {
    fontSize: 12,
    color: "#fff",
    opacity: 0.8,
  ...
  answerGradient: { padding: 20, alignItems: "center" },
  answerText: { marginTop: 8, fontSize: 16, fontWeight: "600" },
  cancelQuestionsButton: {
    borderTopWidth: 1,
    paddingVertical: 16,
    alignItems: "center",
  },
  cancelQuestionsText: { fontSize: 14, fontWeight: "500" },
  ...
  loadingProgressText: { fontSize: 28, fontWeight: "bold" },
  loadingSteps: {
    width: "100%",
    marginBottom: 30,
  ...
  loadingStepDot: { width: 10, height: 10, borderRadius: 5, marginRight: 12 },
  loadingStepText: { fontSize: 15, flex: 1 },
  loadingMessage: {
    fontSize: 15,
    textAlign: "center",
    marginBottom: 25,
  ...
  loadingLinearFill: { height: "100%", borderRadius: 4 },
  loadingCancelButton: {
    flexDirection: "row",
    alignItems: "center",
    paddingVertical: 14,
  ...
  loadingCancelText: { fontSize: 15, fontWeight: "500" },
});
