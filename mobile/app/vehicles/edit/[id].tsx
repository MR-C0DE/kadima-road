// app/vehicles/edit/[id].tsx - Version avec header cohérent
...
export default function EditVehicleScreen() {
  ...
  useEffect(() => {
    if (id && id !== "undefined") {
      ...
      Alert.alert("Erreur", "ID du véhicule invalide");
      router.back();
    }
  }, [id]);
  ...
  const isFormValid = () => {
    const requiredFields = ["make", "model", "year", "licensePlate"];
  ...
  const handleSubmit = async () => {
    ...
    try {
      await api.put(`/vehicles/${id}`, updateData);
      ...
      Toast.show({
        type: "success",
        text1: "✅ Modification enregistrée",
        text2: `${form.make} ${form.model} a été mis à jour`,
        position: "bottom",
        visibilityTime: 3000,
      });
  ...
  const handleDelete = () => {
    ...
    Alert.alert(
      ...
      `Voulez-vous vraiment supprimer ${form.make} ${form.model} ?\n\nCette action est irréversible.`,
      [
        {
          text: "Annuler",
          style: "cancel",
        ...
        },
        {
          ...
          onPress: async () => {
            ...
            try {
              ...
              Toast.show({
                type: "success",
                text1: "Véhicule supprimé",
                text2: `${form.make} ${form.model} a été retiré de votre garage`,
                position: "bottom",
              });
              ...
              Toast.show({
                type: "error",
                text1: "Erreur",
                text2: "Impossible de supprimer le véhicule",
                position: "bottom",
              });
              setDeleting(false);
            }
  ...
  return (
    ...
    >
      ...
      {/* Header avec gradient - style cohérent */}
      <LinearGradient
        colors={[colors.primary, colors.secondary]}
        style={styles.header}
        start={{ x: 0, y: 0 }}
      ...
      >
        <View style={styles.form}>
          ...
          >
            ...
            {renderInput("make", "Marque", "car", {
              required: true,
              autoCapitalize: "words",
            })}
            {renderInput("model", "Modèle", "car-sport", {
              required: true,
              autoCapitalize: "words",
            })}
            {renderInput("year", "Année", "calendar", {
              required: true,
          ...
          >
            ...
            {renderInput("color", "Couleur", "color-palette", {
              autoCapitalize: "words",
            })}
            {renderInput("vin", "Numéro VIN", "qr-code", {
              autoCapitalize: "characters",
              maxLength: 17,
            })}
            {renderFuelSelector()}
